...
metadata {
    definition (name: "Tasmota Power Monitor Switch", namespace: "Gassgs", author: "Gary G") {
        capability "Switch"
        capability "Actuator"
        capability "Sensor"
...
def on(){
    sendEvent(name:"error",value:"Switch is controlled by power monitoring")
}
