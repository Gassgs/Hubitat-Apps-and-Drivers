 ...
 */
metadata {
    definition (name: "iblinds V3.0", namespace: "iblinds, Gassgs", author: "HAB") {
 ...
 fingerprint inClusters: "0x25,0x85"
    fingerprint mfr: "0287", prod: "0004", model: "V3.1", deviceJoinName: "iblinds V3.1" //US
    fingerprint deviceId: "71", inClusters: "0x5E,0x25,0x85,0x59,0x55,0x86,0x72,0x5A,0x73,0x9F,0x6C,0x7A,0x80,0x26,0x70" 
...
def lifeLineAssoc() {
    if (logEnable)  log.debug  "Lifeline to Hub "
